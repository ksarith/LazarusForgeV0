...
- Resolved 2026-07-02: Security_Protocols.md's own SEC-007 sidecar entry is now split into SEC-007a/SEC-007b, matching the split registered here since v4.4 (Security_Protocols.md v0.7). Grok/Gemini G3/G6 gate-maturity disagreement (flagged v4.4) remains unresolved, pending human ruling.
