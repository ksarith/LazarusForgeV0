...
- Reconcile this file's SEC-007 sidecar entry (below, Auditor Notes & Unknowns) into SEC-007a/SEC-007b at next revision — it has not yet been split to match `Unknowns.md` v4.4, and PAT-001/PAT-002 are written against the split IDs.
...
Version 0.6 — External Design Lineage added (2026-07-02); underlying audit
maturity unchanged since four-agent pass (2026-06-19).
